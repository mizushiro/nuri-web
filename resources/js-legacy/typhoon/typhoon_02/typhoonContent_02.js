...
ContentManager.prototype.addNearlest = function(feature) {
  ...
  for (var k = 0 ; k < typhoons.length ; k++) {
...
ContentManager.prototype.loadTlb = function() {
  ...
  function loadTlb2(data63Arr) {
    ...
    $.post(urlPrefix + 'repositary/xml/typ/raw/DAOU/RTKO64/RTKO64.tbl', function(data64) {
...
//          mapManager.addNoItemMsgControl(); //현재 진행 중인 태풍 또는 열대저압부가 없습니다.
  ...
  //현재진행중인 태풍 목록 조회
  $.post(urlPrefix + 'repositary/xml/typ/raw/DAOU/RTKO63/RTKO63.tbl', function(data63) {
