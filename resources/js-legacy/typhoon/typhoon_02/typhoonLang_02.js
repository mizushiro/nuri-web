...
typhoonLang.ko = {
  ...
  , 'conte.0003': '{0}일 {1}시 현재'
  , 'conte.0004': '{0}일 {1}시 예상'
  ...
  , 'typho.0011': '{0}시 예상'
  , 'typho.0012': '현재'
  , 'typho.0013': '{0}년 제{1}호 태풍 {2}<br/>({3}시)'
  , 'typho.0014': '<li>중심위치: {0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa) <font color="#250369">{4}</font></li><li>강풍반경(예외반경): {5}㎞({6} 약{7}㎞) <font color="#250369">{8}</font></li>'
  , 'typho.0014.1': '<li>중심위치: {0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa) <font color="#250369">{4}</font></li><li>강풍반경(예외반경): {5}㎞(-) <font color="#250369">{6}</font></li>'
  , 'typho.0015': '{0}년 제{1}호 열대저압부 {2}<br/>({3}시)'
  , 'typho.0016': '<li>중심위치:{0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa)</li><li>이동속도(진행방향): {4}㎞/h({5})</li>'
  , 'typho.0017': '현재 진행중인 태풍 또는 열대저압부가 없습니다.'
  , 'typho.0018': '선택된 태풍보기'
  , 'typho.0019': '모든 태풍보기'


  , 'typho.n.0011': '{0}.{1}.{2}. {3}시' /*{yyyy}.{MM}.{DD}. {hh}*/
  , 'typho.n.0013': '{0}년 제{1}호 태풍 {2}<br/>({3})'
  , 'typho.n.0014': '<li>중심위치: {0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa) <font color="#250369">{4}</font></li><li>강풍반경(예외반경): {5}㎞({6} 약{7}㎞) <font color="#250369">{8}</font></li>'
  , 'typho.n.0011.1': '{0}.{1}. {2}UTC Forecast' /* 이전 태풍 라인 선택 시 시간표시 */
  , 'typho.n.0013.1': '{0}년 제{1}호 태풍 {2}' /* 이전 태풍 라인 선택 시 */
  , 'typho.n.0014.1': '<li>{0} ~ {1}</li>' /* 이전 태풍 라인 선택 시 */
  , 'typho.n.0013.2': '검색 범위' /* 격자 선택 시 */
  , 'typho.n.0014.2': '<li>{0}˚N,{1}˚E ~ {2}˚N,{3}˚E</li>' /* 격자 선택 시 */
  , 'typho.n.0015': '{0}년 제{1}호 열대저압부<br/>({2})'
  , 'typho.n.0016': '<li>중심위치:{0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa)</li><li>이동속도(진행방향): {4}㎞/h({5})</li>'
  , 'typho.n.0017.01': '<li>중심위치:{0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa)</li><li>이동속도(진행방향): {4}㎞/h({5})<br/><font color="#E0040B">열대저압부로 약화</font></li>'
  , 'typho.n.0017.02': '<li>중심위치:{0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa)</li><li>이동속도(진행방향): {4}㎞/h({5})<br/><font color="#E0040B">온대저기압으로 변질</font></li>'
  , 'typho.n.0018': '<li>중심위치:{0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa)</li><li>이동속도(진행방향): {4}㎞/h({5})<br/><font color="#E0040B">제{6}호 태풍에서 약화</font></li>'
  , 'typho.n.0019': '<li>중심위치: {0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa) <font color="#250369">{4}</font></li><li>강풍반경(예외반경): {5}㎞({6} 약{7}㎞) <font color="#250369">{8}</font><br/><font color="#E0040B">제 {9}호 열대저압부에서 발달</font></li>'
  
  , 'typho.n.0014.01': '<li>중심위치: {0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa) <font color="#250369">{4}</font></li><li>강풍반경(예외반경): {5}㎞(-) <font color="#250369">{6}</font></li>'
  , 'typho.n.0014.02': '<li>중심위치: {0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa) <font color="#250369">{4}</font></li><li>강풍반경(예외반경): {5}㎞(-) <font color="#250369">{6}</font><br/><font color="#E0040B">온대저기압으로 변질</font></li>'
  , 'typho.n.0019.01': '<li>중심위치: {0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa) <font color="#250369">{4}</font></li><li>강풍반경(예외반경): {5}㎞(-) <font color="#250369">{6}</font><br/><font color="#E0040B">제 {7}호 열대저압부에서 발달</font></li>'

  , 'typho.n.0001': '검색모드'
  , 'typho.n.0002': '조회모드'
  , 'typho.n.0003': '태풍 발표 정보 숨기기'
  , 'typho.n.0004': '태풍 발표 정보 보기'


  , 'commo.n.0001': '태풍목록 보기'
  , 'commo.n.0002': '검색조건 보기'
  , 'commo.n.0003': '그래프 크게보기'
...
typhoonLang.en = {
  ...
  , 'utils.0023': 'Medium'
  , 'utils.0024': 'Large'
  , 'utils.0025': 'Extra Large' /*typhoonContents*/
  ...
  , 'typho.0013': 'No. {0} Typhoon {1}<br/>({2})'
  , 'typho.0014': '<li>Position:{0}˚N,{1}˚E</li><li>Maximum sustained wind(Central pressure):{2}㎧({3}hPa) <font color="#250369">{4}</font></li><li>Radius of 15㎧(Radius at short axis):{5}㎞({7}㎞ {6}) <font color="#250369">{8}</font></li>'
  , 'typho.0015': 'No. {0} Tropical Depression<br/>({1})'
  ...
  , 'typho.n.0011': '{0}.{1}.{2}. {3}' /*{yyyy}.{MM}.{DD}. {hh}*/
  , 'typho.n.0013': 'No. {0} Typhoon {1}<br/>({2})'
  , 'typho.n.0014': '<li>Position:{0}˚N,{1}˚E</li><li>Maximum sustained wind(Central pressure):{2}㎧({3}hPa) <font color="#250369">{4}</font></li><li>Radius of 15㎧(Radius at short axis):{5}㎞({7}㎞ {6}) <font color="#250369">{8}</font></li>'
  , 'typho.n.0011.1': '{0}.{1}. {2}' /* 이전 태풍 라인 선택 시 시간표시 */
  , 'typho.n.0013.1': 'No. {0} Typhoon {1}' /* 이전 태풍 라인 선택 시 */
  , 'typho.n.0014.1': '<li>{0} ~ {1}</li>' /* 이전 태풍 라인 선택 시 */
  , 'typho.n.0013.2': 'Coordinate Range' /* 격자 선택 시 */
  , 'typho.n.0014.2': '<li>{0}˚N,{1}˚E ~ {2}˚N,{3}˚E</li>' /* 격자 선택 시 */
