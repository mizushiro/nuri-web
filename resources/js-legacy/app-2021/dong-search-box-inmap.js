...
(function($, window, document){
	...
	DongSearchboxInMap = function(wrapperId) {
	...
	if (typeof exports !== 'undefined') exports.DongSearchboxInMap = DongSearchboxInMap;
	else window.DongSearchboxInMap = DongSearchboxInMap;
