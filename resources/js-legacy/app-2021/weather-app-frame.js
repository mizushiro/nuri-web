...
function bookmarkInit() {
	...
	Util.send( { action: 'bookmark-init', bookmarks: bookmarkConfig.bookmarks, selectedBookmark: bookmarkConfig.selectedBookmark }, MAIN_FRAME_WINDOW);
}
