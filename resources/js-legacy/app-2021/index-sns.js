        ...
        updateSnsOrder: function(data) {
            ...
            for(var i = 0 ; i < data.length ; i++) {
                ...
                if(item.order == 1) {
                	...
                	$holder.find('i[class="icon-yeptv"]').attr('class', 'icon-yout').find('span').text('유튜브');
                	$target.find('i[class="icon-yout"]').attr('class', 'icon-yeptv').find('span').text('옙TV');
                }
                break;
            }
        },
