...
(function($, window, document){
	...
	SeaMidTerm.prototype = {
		...
		getData: function(area) {
			...
			var unit = (self.appConfig && self.appConfig.unit) ? self.appConfig.unit.ws:"m/s";
			var data = {
			...
			return $.ajax({
				url: prefix + "wnuri-sfct/today/mid-term.do",
				data: data,
				dataType: "html"
			});
		},
	...
	if (typeof exports !== 'undefined') exports.SeaMidTerm = SeaMidTerm;
	else window.SeaMidTerm = SeaMidTerm;
