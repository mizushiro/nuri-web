...
(function($, window, document){
	var LayerBanner2 = function(id, bannerImageFileName, bannerText, linkText, linkUrl) {
	...
	LayerBanner2.prototype = {
		...
		createMarkup: function() {
			...
			self.$wrapper.html('<div class="laba-bg"></div><div class="laba-body"><img class="laba-body-image" src="' + window.appBase + '/resources/image/banner/' + self.bannerImageFileName + '" alt="' + self.bannerText + '"/>'
				+ '<div class="laba-link"><a href="' + self.linkUrl+ '" target="_blank">' + self.linkText + '</a></div></div>' 
	...
	if (typeof exports !== 'undefined') exports.LayerBanner2 = LayerBanner2;
	else window.LayerBanner2 = LayerBanner2;
