...
(function($, window, document){
	...
	*/
	...
	function updateWarningTab(warningExists) {
		if(warningExists) {
			$('.cmp-main-tabs .tab-head.wrn').addClass('active');
		} else {
			$('.cmp-main-tabs .tab-head.wrn').parent().remove();
		}
	}
	window.updateWarningTab = updateWarningTab; 
...
//		var $tabs = $('.cmp-main-tabs');
//		var $newTab = $('<div class="tab-item">');
//		$newTab.append('<h2 class="tab-head wrn"><a href="#">특보</a></h2>')
//			.append('<div class="tab-content" id="index-warning-info"></div>')
//			.appendTo($tabs);
//		var dongCode = "";
//		if(bookmarkDropdown 
//					&& bookmarkDropdown.config 
//					&& bookmarkDropdown.config.selectedBookmark
//					&& bookmarkDropdown.config.selectedBookmark.dong) {
//			dongCode = bookmarkDropdown.config.selectedBookmark.dong.code;
//		}
//		$.ajax({
//			url: appPrefix + 'wnuri-fct2021/weather/warning-tab.do',
//			data: { code: dongCode },
//			type: 'get',
//			dataType: 'html'
//		}).then(
//			function(html) {
//				$('#index-warning-info').html(html);
//			},
//			function(err) {
//				console.log(err);
//			}
//		);
	...
	function createDefaultModeEvent() {
		...
		$('#index-warning-info').on('click', 'a', function(e) {
			e.preventDefault();
			openExternalPop(this.href);
		});
