...
(function($, window, document){
	...
	SeaNearObs.prototype = {
		...
		getData: function(area) {
			...
			return $.ajax({
				url: prefix + "wnuri-sfct/today/near-obs.do",
				data: data,
				dataType: "html"
			});
		},
	...
	if (typeof exports !== 'undefined') exports.SeaNearObs = SeaNearObs;
	else window.SeaNearObs = SeaNearObs;
