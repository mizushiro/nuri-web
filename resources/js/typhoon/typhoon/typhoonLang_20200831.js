...
//    'graph.0020': '최대풍속(㎧)',
    ...
    'typho.0009': '모든 태풍보기',
    'typho.0010': '선택된 태풍보기',
//    'typho.0011': '{0}시 예상',    2016-07-29일 수정
    ...
    'typho.0014.01': '<li>중심위치: {0}˚N,{1}˚E</li><li>최대풍속(중심기압): {2}㎧({3}hPa) <font color="#250369">{4}</font></li><li>강풍반경(예외반경):  <font color="#250369">{6}</font></li>',
    ...
    'commo.0013' : '최대풍속', 
    'commo.0014' : '강풍반경(km)<br />[예외반경]', 
    'commo.0015' : '강도', 
    'commo.0016' : '크기', 
    'commo.0017' : '진행<br />방향', 
    'commo.0018' : '이동<br />속도<br />(km/h)', 
    'commo.0019' : '70%<br />확률반경<br />(km)', 
    'commo.0020' : '위도(˚N)', 
    'commo.0021' : '경도(˚E)', 
    'commo.0022' : '초속<br />(m/s)', 
    'commo.0023' : '시속<br />(km/h)', 
