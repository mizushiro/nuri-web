...
(function($, window, document){
	...
	WeatherShortTerm = function(wrapperId) {
	...
	WeatherShortTerm.prototype = {
		...
		getData: function(code, unit) {
			...
			return $.ajax({
				url: prefix + "wnuri-fct/weather/short-term.do",
				data: data,
				dataType: "html"
			});
		},
	...
	if (typeof exports !== 'undefined') exports.WeatherShortTerm = WeatherShortTerm;
	else window.WeatherShortTerm = WeatherShortTerm;
